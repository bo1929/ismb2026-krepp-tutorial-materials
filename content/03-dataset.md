...
<img src="figures/dataset_overview.png" alt="Dataset overview." style="display: block; margin: 1rem auto; width: 100%; max-width: 900px; height: auto;" />
...
**Figure 2.**
A toy phylogeny built using Mash distances and neighbor-joining, queries are colored in red.
...
The same species may appear at tips both as query and reference, which correspond to queries that are least novel (another genome from the exact same species is present in the reference).
